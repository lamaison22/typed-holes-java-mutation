...
public class JRGCore {
    ...
    @Provide
    public Arbitrary<MethodCallExpr> genMethodInvokation(Map<String,String> ctx,
            Type t)throws ClassNotFoundException {
        JRGLog.showMessage(JRGLog.Severity.MSG_XDEBUG, "genMethodInvokation:"
                + ":inicio");

        Arbitrary<Method> methods;
        
        JRGLog.showMessage(JRGLog.Severity.MSG_DEBUG, "genMethodInvokation:"
                + ":t = " + t.asString());
        ...
        JRGLog.showMessage(JRGLog.Severity.MSG_DEBUG, "genObjectCreation:"
    ...
    public Arbitrary<Expression> genExpressionMatchOperatorFor(Map<String,String> ctx, Type t,  VariableDeclarator e, Arbitrary<LiteralExpr> ex ) {
