...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(-57411, -1, false).getA2() + 20 + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 0.99 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(-57411, -1, false).getA2() + 20 + 2131;
        boolean esseRecebeOqJaExisteBool = false;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(-121220);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(-121220);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-4066, -1828, true);
        testePassadoParametro(89, esseRecebeOqJaExisteBool);
        int betano = 20000;
