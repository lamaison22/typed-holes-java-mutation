...
public class MainClass_2 {
    ...
    public static void main(String[] args) {
        br.edu.ifsc.javargexamples.A aInst = new A(-2352194, 79, true);
        br.edu.ifsc.javargexamples.B bInst = new B(true, false);
        if (aInst.a3 && true) {
            br.edu.ifsc.javargexamples.Aextend aExt = new Aextend(7587, 91812);
    ...
    public int metodoCalculo() {
        int x = -192;
        int y = 5;
        double resultado = x + y + 3964.08;
        br.edu.ifsc.javargexamples.C cInst = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.D dInst = new D(new br.edu.ifsc.javargexamples.B(933978), cInst);
