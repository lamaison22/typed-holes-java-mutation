...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(-3, -4403939, false).a1 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 1708.99 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(-3, -4403939, false).a1 + 2131;
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(8982, 831435, false);
        testePassadoParametro(140, esseRecebeOqJaExisteBool);
        int betano = 20000;
