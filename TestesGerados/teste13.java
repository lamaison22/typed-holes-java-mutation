...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(21179, -17, true).a1 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 20.8 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(21179, -17, true).a1 + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(-1725);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(-1725);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-9, 1017170, false);
        testePassadoParametro(-683412, esseRecebeOqJaExisteBool);
        int betano = 20000;
