...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(-586, -270911069, true).getA1() - -1410 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 2.07 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(-586, -270911069, true).getA1() - -1410 + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B();
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-207, 11189, false);
        testePassadoParametro(99712, esseRecebeOqJaExisteBool);
        int betano = 20000;
