...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = 100066 + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 15.36 + 300;
        double esseRecebeOqJaExiste = 100066 + 2131;
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-14471, -198, true);
        testePassadoParametro(-1123, esseRecebeOqJaExisteBool);
        int betano = 20000;
