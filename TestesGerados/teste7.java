...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = -25 + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 0.5 + 300;
        double esseRecebeOqJaExiste = -25 + 2131;
        boolean esseRecebeOqJaExisteBool = false;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(-35415732);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(-35415732);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(1201830559, -1889, false);
        testePassadoParametro(4267, esseRecebeOqJaExisteBool);
        int betano = 20000;
