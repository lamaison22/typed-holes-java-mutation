...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(2147483647, -888906980, false).a1 + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 0.09 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(2147483647, -888906980, false).a1 + 2131;
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(38648, 883, false);
        testePassadoParametro(1, esseRecebeOqJaExisteBool);
        int betano = 20000;
