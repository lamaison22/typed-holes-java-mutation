...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(-1367, -1626, false).a2 - 153 % 0 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 2655.27 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(-1367, -1626, false).a2 - 153 % 0 + 2131;
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-36, 19, false);
        testePassadoParametro(19, esseRecebeOqJaExisteBool);
        int betano = 20000;
