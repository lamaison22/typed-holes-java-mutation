...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(-601144483, 2329, true).a1 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 392.79 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(-601144483, 2329, true).a1 + 2131;
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(1037427177, -63, false);
        testePassadoParametro(-793, esseRecebeOqJaExisteBool);
        int betano = 20000;
