...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.B(-2).getB() + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 6.08 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.B(-2).getB() + 2131;
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-1941273861, 1128, false);
        testePassadoParametro(-3, esseRecebeOqJaExisteBool);
        int betano = 20000;
