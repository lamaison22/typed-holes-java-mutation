...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(75, 3, true).getA1() + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 1257.94 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(75, 3, true).getA1() + 2131;
        boolean esseRecebeOqJaExisteBool = false;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(false, true);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(false, true);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(1, -23, true);
        testePassadoParametro(-33908, esseRecebeOqJaExisteBool);
        int betano = 20000;
