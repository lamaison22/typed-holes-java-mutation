...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(20, -105374, false).a2 * -5561128 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 0.33 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(20, -105374, false).a2 * -5561128 + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(1106850557);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(1106850557);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(4, -965246, true);
        testePassadoParametro(-11917, esseRecebeOqJaExisteBool);
        int betano = 20000;
