...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = -11765 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 3.54 + 300;
        double esseRecebeOqJaExiste = -11765 + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(-4563);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(-4563);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(44, 9785, true);
        testePassadoParametro(-28968, esseRecebeOqJaExisteBool);
        int betano = 20000;
