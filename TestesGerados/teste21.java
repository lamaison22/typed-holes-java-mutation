...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.B(false, false).getB() - 74660 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 432.63 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.B(false, false).getB() - 74660 + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(true, true);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(true, true);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-91042, 1, false);
        testePassadoParametro(63, esseRecebeOqJaExisteBool);
        int betano = 20000;
