...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(0, -1684, true).getA1() + 179527447 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 90.46 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(0, -1684, true).getA1() + 179527447 + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(54);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(54);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(10647, 1241193072, true);
        testePassadoParametro(-1115880731, esseRecebeOqJaExisteBool);
        int betano = 20000;
