...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(-2147483648, -25, false).a2 + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 8.14 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(-2147483648, -25, false).a2 + 2131;
        ...
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(7071, -2147483648, true);
        testePassadoParametro(87252, esseRecebeOqJaExisteBool);
        int betano = 20000;
