...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(-49, 689557, true).getA2() + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 180.57 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(-49, 689557, true).getA2() + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(3632);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(3632);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-13205, -2147483648, true);
        testePassadoParametro(-38, esseRecebeOqJaExisteBool);
        int betano = 20000;
