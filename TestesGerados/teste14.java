...
public class MainClass {
    ...
    public static void main(String[] args) {
        if (new br.edu.ifsc.javargexamples.A(-145, -753, false).a3) {
            if (true) {
                ...
                byte a = 1;
                short u = -107;
                br.edu.ifsc.javargexamples.Aextend na = new br.edu.ifsc.javargexamples.Aextend(1428588, 2591583);
                byte yg = -128;
            }
        } else {
            int xn;
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(284, -146613639, true).a2 + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 238.07 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(284, -146613639, true).a2 + 2131;
        boolean esseRecebeOqJaExisteBool = false;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(false, false);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(false, false);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(837845, 1886, false);
        testePassadoParametro(-282127, esseRecebeOqJaExisteBool);
        int betano = 20000;
