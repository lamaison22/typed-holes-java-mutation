...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.B(-2585).getB() + 1;
        boolean essaTrocaBool = false;
        ;
        double essaTrocaDouble = 11.33 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.B(-2585).getB() + 2131;
        boolean esseRecebeOqJaExisteBool = false;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B(true, false);
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B(true, false);
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-8, 1893453588, false);
        testePassadoParametro(-1095, esseRecebeOqJaExisteBool);
        int betano = 20000;
