...
public class MainClass {
    ...
    public int testeMetodo() {
        int assai = 1;
        int essaquetroca = new br.edu.ifsc.javargexamples.A(2, -1125132, true).getA2() + 1;
        boolean essaTrocaBool = true;
        ;
        double essaTrocaDouble = 65.68 + 300;
        double esseRecebeOqJaExiste = new br.edu.ifsc.javargexamples.A(2, -1125132, true).getA2() + 2131;
        boolean esseRecebeOqJaExisteBool = true;
        br.edu.ifsc.javargexamples.B novoB = new br.edu.ifsc.javargexamples.B() + 123;
        br.edu.ifsc.javargexamples.B novoBdenovo = new br.edu.ifsc.javargexamples.B();
        br.edu.ifsc.javargexamples.C novoC = new br.edu.ifsc.javargexamples.C();
        br.edu.ifsc.javargexamples.A novoA = new br.edu.ifsc.javargexamples.A(-4, 0, false) - new br.edu.ifsc.javargexamples.B();
        testePassadoParametro(-8463, esseRecebeOqJaExisteBool);
        int betano = 20000;
